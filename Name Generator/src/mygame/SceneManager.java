...
public class SceneManager extends AbstractAppState {
  ...
  private void initScene() {
      ...
      Node scene = (Node) assetManager.loadModel("Scenes/China.j3o");
      app.getRootNode().attachChild(scene);
      app.getCamera().setLocation(scene.getChild("CameraSpot").getLocalTranslation().add(1,3,5));
      app.getFlyByCamera().setEnabled(false);
      app.getCamera().lookAt(new Vector3f(-3,-1,0), new Vector3f(0,1,0));
      makeUnshaded();
