...
public class GuiManager extends AbstractAppState {
  ...
  private void initNameBox() {
      ...
      nameBox.setDimensions(screen.getWidth() / 1.8f, screen.getHeight()/6);
      ...
      nameBox.setFont("Interface/Fonts/Karate.fnt");
      nameBox.setFontSize(40);
      nameBox.setTabFocus();
  ...
  private void initTranslateButton() {
      ...
      translateButton.setFont("Interface/Fonts/Karate.fnt");
  ...
  for (int i = 0 ; i < check.getChildren().size(); i++) {
    ...
    if (check.getChild(i) instanceof ButtonAdapter) {
        ...
        key.setFont("Interface/Fonts/Karate.fnt");
        key.setText(label);
